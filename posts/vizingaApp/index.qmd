...
Cage aquaculture is a promising way to increase fish production in Tanzania's Lake Victoria [@stateofcageculture; @cageculture2]. However, proper planning is crucial to ensure the sustainability and success of such ventures [@mlaponi]. That's where the Shiny app for planning cage aquaculture comes in [@fig-home].
...
This app, which is still under active development, but its beta version is up and running online [here](https://semba.shinyapps.io/vizingaApp/) provides users with a range of tools and information to help them make informed decisions about their cage aquaculture projects. Users can input data such as the size and location of their cages, the type of fish they want to farm, and the expected production volume. The app then uses this information to generate a detailed plan that takes into account factors such as water quality, feed requirements, and environmental impacts.
...
Here are some  features that a Shiny app focused on cage culture offers:
